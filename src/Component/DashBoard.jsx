...
const Home = () => {
  ...
  const pieChartData = {
    labels: data.map((item) => `${item.maonth}`),
    datasets: [
      {
        ...
        <Grid container spacing={3} sx={{ mt: 4 }}>
          ...
          <Grid item xs={8} md={5}>
            <Paper sx={{ padding: 3, backgroundColor: "#1a3a5c", color: "white", textAlign: "center" }}>
              ...
              <Pie data={pieChartData} style={{ width: "200px", height: "400px", margin: "0 auto" }} />
            </Paper>
          </Grid>
          <Grid item xs={8} md={5}>
            <Paper sx={{ padding: 3, backgroundColor: "#1a3a5c", color: "white", textAlign: "center" }}>
              <Typography variant="h6">Sales</Typography>
              <VennDiagram style={{ width: "200px", height: "400px", margin: "0 auto", marginTop:"10px" }} />
            </Paper>
          </Grid>
        </Grid>
      </Box>
